...
- [x] **DOC-02**: Mermaid diagrams for pipeline architecture, data flow, experiment design, CLI command map, API call lifecycle sequence, and full experiment run sequence
