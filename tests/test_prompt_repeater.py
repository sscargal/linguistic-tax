...
class TestRepeatPrompt:
    ...
    def test_basic_duplication(self) -> None:
        from prompt_repeater import repeat_prompt
...
class TestSelfCorrect:
    ...
    def test_prefix_starts_correctly(self) -> None:
        from prompt_compressor import SELF_CORRECT_PREFIX
    ...
    def test_build_self_correct_prompt(self) -> None:
        from prompt_compressor import SELF_CORRECT_PREFIX, build_self_correct_prompt
...
class TestMaxTokens:
    ...
    def test_humaneval_max_tokens(self) -> None:
        from config import MAX_TOKENS_BY_BENCHMARK
